// HW 15-2 CSC215 LaGuardia-LoBianco.cpp : Defines the entry point for the console application.
//
...
public:
	...
	ShiftSupervisor() {};
	ShiftSupervisor(double d, double d2) { annualSalary = d; annualBonus = d2; };

	void setAnnualSalary(double s) { annualSalary = s; };
	double getAnnualSalary() { return annualSalary; };

	void setAnnualBonus(double s) { annualBonus = s; };
...
int main()
{
	...
	ShiftSupervisor supervisor1(50000, 15000);
	string s;
	int n;
	int n2;
	int d;
	...
	cin >> s;
	supervisor1.setEmployeeName(s);

	cout << "what is the Supervisor's employee number?" << endl;
	cin >> n;
	supervisor1.setEmployeeNumber(n);

	cout << "what is Supervisor 1's hire date?" << endl;
	cin >> d;
	supervisor1.setHireDate(d);
	...
	cout << "Production Worker 2: " << endl;
	cout << "Supervisor name: " << supervisor1.getEmployeeName() << endl <<
		"Employee number: " << supervisor1.getEmployeeNumber() << endl <<
		"Employee Hire Date: " << supervisor1.getHireDate() << endl <<
		"Supervisor Salary: " << supervisor1.getAnnualSalary() << endl <<
		"Supervisor Bonus: " << supervisor1.getAnnualBonus() << endl;
